...
import { AuditService, AuditAction } from './security/AuditService.js';
...
export class InvestigativeHub {
  ...
  public async processNewCase(caseData: Case, signatures: string[] = [], userId: string = 'system') {
    ...
    AuditService.log({
      ...
      resourceType: 'Case',
      details: 'Processing new case and aggregating intelligence.'
    });
  ...
  public async handleRecovery(caseId: string, pHash: string, userId: string = 'system') {
    ...
    AuditService.log({
      ...
      resourceId: caseId,
      resourceType: 'Case',
      details: 'Case marked as recovered. Initiating digital scrubbing.'
    });
